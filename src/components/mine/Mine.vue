<template>
  <div class="mine">
    ...
    <div class="mine-content">
      ...
      <div class="block theme-btn-light" @click="tuichu()">
        退出当前账号
      </div>
    </div>
  </div>
...
.order-type-11{
  background-image: url("img/order-type-11.png");
}
.order-type-12{
  background-image: url("img/order-type-12.png");
}
.order-type-13{
  background-image: url("img/order-type-13.png");
}
.order-type-14{
  background-image: url("img/order-type-14.png");
}
.mine-item-pointsShop{
  background-image: url("img/mine-item-pointsShop.png");
}
.mine-item-coupon{
  background-image: url("img/mine-item-coupon.png");
}
.mine-item-addrlist{
  background-image: url("img/mine-item-addrlist.png");
}
.mine-item-aftersale{
  background-image: url("img/mine-item-aftersale.png");
}
.mine-item-about{
  background-image: url("img/mine-item-about.png");
}
.mine-order{
  background-color: #fff;
  margin:0 0 1rem 0;
...
.shopFavorite{
  .inner{
    background: url("img/shop_favorite.png") left center no-repeat;
    -webkit-background-size: auto 1.8rem;
    background-size: auto 1.8rem;
    padding-left: 3rem;
    line-height: 2rem;
...
.user{
  ...
  font-weight: 700;
  color: #fff;
  background: url("img/head_portrait.png") 1.5rem bottom no-repeat;
  -webkit-background-size: auto 6rem;
  background-size: auto 6rem;
  &:after{
    background: url("img/user_info_bg.png") 0 0 no-repeat;
...
.user-level{
  background: url("img/user_level_bg.png") left center no-repeat;
